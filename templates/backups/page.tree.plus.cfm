									...
									<div class="widget-header">		
										...
										<div class="widget-content">						
											...
											<div class="tabbable">
												...
												<cfinvoke component="apis.com.optiontree6" method="getoptiontree6" returnvariable="optiontree6">
													<cfinvokeargument name="leadid" value="#session.leadid#">
												</cfinvoke>								
												
												<cfif optiontree6.subcat6 is not true >
													...
													<div class="tab-content">													
															...
															<div class="accordion" id="basic-accordion">
																...
																<cfif optiontree6.subcat6cancelunpaid is true >
																	...
																	<cfinvoke component="apis.com.clarifyingpoints" method="getunpaidlist" returnvariable="unpaidlist">
																		<cfinvokeargument name="treenum" value="6">
																...
																<cfelseif optiontree6.subcat6canceldeath is true>
																...
																<cfelse>
																	...
																	<div class="alert alert-error">
																		...
																		<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Cancellation for Parent PLUS Loans...
																	</div>
														...
														<div class="tab-pane" id="tabforgive">
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Forgiveness for Parent PLUS Loans...
																</div>
																<div style="height:350px;"></div>
														...
														<div class="tab-pane" id="tabdefault">
															<cfif optiontree6.subcat6default is true >
																<cfif trim( optiontree6.subcat6rehab ) is "yes" >
																...
																<cfelseif trim( optiontree6.subcat6consol ) is "yes" >
																...
																<cfelseif trim( optiontree6.subcat6wg ) is "yes" >
																...
																<cfelseif trim( optiontree6.subcat6to ) is "yes" >
															...
															<cfelse>
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Default Intervention for Parent PLUS Loans...
																</div>
																<div style="height:350px;"></div>
															</cfif>
														</div>
														...
														<div class="tab-pane" id="tabpost">
															<cfif optiontree6.subcat6post is true >
																<cfif trim( optiontree6.subcat6postdefer ) is "yes" >
																...
																<cfelseif trim( optiontree6.subcat6postforbear ) is "yes" >
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Postponement for Parent PLUS Loans...
																</div>
																<div style="height:350px;"></div>
														...
														<div class="tab-pane" id="taboffer">
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Offer in Compromise for Parent PLUS Loans...
																</div>
																<div style="height:350px;"></div>
														...
														<div class="tab-pane" id="tabbank">
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under bankruptcy for Parent PLUS Loans...
																</div>
																<div style="height:350px;"></div>
