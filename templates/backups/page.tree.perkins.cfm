									...
									<div class="widget-header">		
										...
										<div class="widget-content">						
											...
											<div class="tabbable">
												...
												<cfinvoke component="apis.com.optiontree3" method="getoptiontree3" returnvariable="optiontree3">
													<cfinvokeargument name="leadid" value="#session.leadid#">
												</cfinvoke>

												<cfif optiontree3.subcat3 is not true >
													...
													<div class="tab-content">													
														...
														<div class="tab-pane active" id="tabcancel">
															...
															<div class="accordion" id="basic-accordion">																
																...
																<cfelseif optiontree3.subcat3canceldeath is true>
																...
																<cfelse>
																	...
																	<div class="alert alert-error">
																		...
																		<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Cancellation for Perkins Loans...
																	</div>
														...
														<div class="tab-pane" id="tabforgive">
															<cfif optiontree3.subcat3ocforgive is true >
																...
																<cfinvoke component="apis.com.clarifyingpoints" method="getoclist" returnvariable="oclist">
																	<cfinvokeargument name="treenum" value="3">
																	<cfinvokeargument name="branchname" value="Occupational Cancellation">
																</cfinvoke>
																		...
																		<div class="accordion-group">
																			...
																			<div id="ceight" class="accordion-body in collapse">
																				...
																				<!--- // show the solution button to add to solution presentation --->
																				<cfoutput>
																					<a href="#application.root#?event=page.tree" style="margin-left:30px;" class="btn btn-small btn-secondary"><i class="icon-circle-arrow-left"></i> Return to Option Tree</a><a href="#application.root#?event=page.worksheet.solution&tree=#tree#&option=forgive&solution=oc" style="margin-left:5px;" class="btn btn-small btn-primary"><i class="icon-circle-arrow-right"></i> Choose This Solution</a>
																				</cfoutput>
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Forgiveness for Perkins Loans...
																</div>
																<div style="height:350px;"></div>
														...
														<div class="tab-pane" id="tabdefault">
															...
															<cfif trim( optiontree3.subcat3rehab ) is "yes" >
															...
															<cfelseif trim( optiontree3.subcat3consol ) is "yes" >
															...
															<cfelse>
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Default Intervention for Perkins Loans...
																</div>
																<div style="height:350px;"></div>
														...
														<div class="tab-pane" id="tabpost">
															<cfif optiontree3.subcat3post is true >
																<cfif trim( optiontree3.subcat3postdefer ) is "yes" >
																...
																<cfelseif trim( optiontree3.subcat3postforbear ) is "yes" >
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Postponement for Perkins Loans...
																</div>
																<div style="height:350px;"></div>
														...
														<div class="tab-pane" id="taboffer">
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Offer in Compromise for Perkins Loans...
																</div>
																<div style="height:350px;"></div>
														...
														<div class="tab-pane" id="tabbank">
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under bankruptcy for Perkins Loans...
																</div>
																<div style="height:350px;"></div>
