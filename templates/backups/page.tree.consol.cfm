									...
									<div class="widget-header">		
										...
										<div class="widget-content">						
											...
											<div class="tabbable">
												...
												<cfinvoke component="apis.com.optiontree4" method="getoptiontree4" returnvariable="optiontree4">
													<cfinvokeargument name="leadid" value="#session.leadid#">
												</cfinvoke>

												<cfif optiontree4.subcat4 is not true >
													...
													<div class="tab-content">													
															...
															<div class="accordion" id="basic-accordion">
																...
																<cfif optiontree4.subcat4cancelunpaid is true>
																	...
																	<cfinvoke component="apis.com.clarifyingpoints" method="getunpaidlist" returnvariable="unpaidlist">
																		<cfinvokeargument name="treenum" value="4">
																...
																<cfelseif optiontree4.subcat4canceldeath is true>
																...
																<cfelse>
																	...
																	<div class="alert alert-error">
																		...
																		<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Cancellation for Direct Consolidation Loans...
																	</div>
														...
														<div class="tab-pane" id="tabforgive">
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Forgiveness for Direct Consolidation Loans...
																</div>
																<div style="height:350px;"></div>
														...
														<div class="tab-pane" id="tabdefault">
															<cfif optiontree4.subcat4default is true >
																<cfif trim( optiontree4.subcat4rehab ) is "yes" >
																...
																<cfelseif trim( optiontree4.subcat4consol ) is "yes" >
																...
																<cfelseif trim( optiontree4.subcat4wg ) is "yes" >
																...
																<cfelseif trim( optiontree4.subcat4to ) is "yes" >
															...
															<cfelse>
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Default Intervention for Direct Consolidation Loans...
																</div>
																<div style="height:350px;"></div>
															</cfif>
														</div>
														...
														<div class="tab-pane" id="tabpost">
															<cfif optiontree4.subcat4post is true >
																<cfif trim( optiontree4.subcat4postdefer ) is "yes" >
																...
																<cfelseif trim( optiontree4.subcat4postforbear ) is "yes" >
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Postponement for Direct Consolidation Loans...
																</div>
																<div style="height:350px;"></div>
														...
														<div class="tab-pane" id="taboffer">
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under Offer in Compromise for Direct Consolidation Loans...
																</div>
																<div style="height:350px;"></div>
														...
														<div class="tab-pane" id="tabbank">
															...
															<cfelse>
																...
																<div class="alert alert-error">
																	<button type="button" class="close" data-dismiss="alert">&times;</button>
																	<strong><i class="icon-check"></i> NOT QUALIFIED!</strong>  Sorry, based on the information entered, you do not qualify for any concessions under bankruptcy for Direct Consolidation Loans...
																</div>
																<div style="height:350px;"></div>
