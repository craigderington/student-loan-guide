									...
									<cfoutput>
										...
										<div class="widget-content">
											...
											<cfif userlist.recordcount gt 0>
												...
												<cfoutput>
													<h5><i style="margin-right:5px;" class="icon-th-large"></i> Currently assigned user accounts:  #userlist.recordcount#.  Licenses remaining: #( compuserdetail.numlicenses - userlist.recordcount )# <cfif compuserdetail.active eq 0><span style="margin-left:15px;padding:5px;" class="label label-important"><i class="icon-warning-sign"></i> Company Inactive</span></cfif><span class="pull-right"><a href="#application.root#?event=page.company.activity" style="margin-bottom:5px;" class="btn btn-medium btn-secondary"><i class="icon-bookmark"></i> View User Activity </a><a href="#application.root#?event=page.depts" style="margin-left:5px;margin-bottom:5px;" class="btn btn-medium btn-default"><i class="icon-building"></i> Manage Departments </a><cfif compuserdetail.active eq 1 and ( compuserdetail.numlicenses neq userlist.recordcount )><a href="#application.root#?event=#url.event#.edit&fuseaction=edit.user&uid=0" style="margin-bottom:5px;margin-left:5px;" class="btn btn-medium btn-primary"><i class="icon-plus"></i> Add New User </a></cfif>     </span></h5>
												</cfoutput>
