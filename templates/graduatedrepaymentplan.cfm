										...
										<div class="widget-content">						
											...
											<div class="span4">
												<cfoutput>	
													...
													<h5 style="margin-top:25px;">&nbsp;</h5>
													<p>#cloanterm#</p>
													<p>#dollarformat( gradInitialPayAmt )#</p>
													<p>#dollarformat( ( gradInitialPayAmt * cloanterm ) - cloaninfo.totalloanamount )#</p>
													<p>#dollarformat( ( gradInitialPayAmt * cloanterm )  / 0.64 )#</p>
												</cfoutput>
											</div>			
										</div><!-- / .widget-content -->										
									</div><!-- // .widget -->
