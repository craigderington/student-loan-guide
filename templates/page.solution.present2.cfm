				...
				<cfoutput>	
					...
					<cfdocumentsection name="Table of Contents">
							...
							<div style="margin-top:50px;">
								...
								<div align="center"><h2 style="font-size:26px;"><strong>Table of Contents</strong></h2></div>
							
							
									<p style="margin-top:50px;margin-left:25px;font-size:16px;">
									<p style="font-size:16px;">I.  Student Loan Action Plan</p>
									...
									<p style="font-size:16px;">II. Student Loan Advisory Manual</p>
										<p style="margin-left:35px;font-size:16px;">
						...
						<cfdocumentitem type="footer">
							...
							<h2 style="text-align:center;margin-top:25px;">Your Loan Types</h2>
								...
								<cfloop query="loantypes">
									<ul>
										<li>#codedescr# while attending #attendingschool#</li>
									</ul>
								</cfloop>
