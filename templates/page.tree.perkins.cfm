				...
				<cfif optiontree3.subcat3rehab is true >
					<cfset tabdefault = true />
				<cfelseif optiontree3.subcat3consol is true >
					<cfset tabdefault = true />
				</cfif>
												...
												<div class="tab-content">													
														...
														<div class="tab-pane <cfif tabforgive is true and tabcancel is false >active</cfif>" id="tabforgive">														
															...
															<cfif optiontree3.subcat3ocforgive is true >
																...
																<cfinvoke component="apis.com.clients.clarifyingpoints" method="getoclist" returnvariable="oclist">
																	<cfinvokeargument name="treenum" value="3">
																...
																<table class="table table-bordered table-striped table-highlight">
																	<thead>
																		<cfoutput>
																		<tr>
																			<th>Occupational Loan Forgiveness <span style="float:right;"><a href="#application.root#?event=page.tree" class="btn btn-mini btn-tertiary">Return to Option Tree</a>&nbsp;&nbsp;<a href="#application.root#?event=page.worksheet.solution&tree=#tree#&option=forgive&solution=oc" class="btn btn-mini btn-primary">Choose This Solution</a></span></th>
																		</tr>
																		</cfoutput>
																	</thead>
																	<tbody>
														...
														<div class="tab-pane <cfif tabdefault is true and tabforgive is false and tabcancel is false >active</cfif>" id="tabdefault">													
																...
																<cfif trim( optiontree3.subcat3consol ) is "yes" >
														...
														<div class="tab-pane <cfif tabrepay is true and tabdefault is false and tabforgive is false and tabcancel is false >active</cfif>" id="tabrepay">														
															...
															<cfif optiontree3.subcat3repay is true >
														...
														<div class="tab-pane <cfif tabpost is true and tabrepay is false and tabdefault is false and tabforgive is false and tabcancel is false >active</cfif>" id="tabpost">														
															...
															<cfif optiontree3.subcat3post is true >
																...
																<cfif trim( optiontree3.subcat3forbear ) is "yes" >
