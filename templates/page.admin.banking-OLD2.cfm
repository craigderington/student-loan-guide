							...
							<cfif structkeyexists( form, "creatensf" ) and structkeyexists( form, "feeid" )>
								...
								<cfif isvalid( "uuid", form.feeid )>								
									...
									<!-- -// get the current note - we don't want to over write the note --->
									<cfset appendfeenote = trim( getfeedetail.feenote ) />
									<cfif appendfeenote eq "">
										<cfset appendfeenote = "Returned NSF" />
									<cfelse>
									...
									<cfquery datasource="#application.dsn#" name="marknsf">
										update fees
										   set feepaiddate = <cfqueryparam value="#thisdate#" cfsqltype="cf_sql_date" />,
											   ...
											   feereturnednsf = <cfqueryparam value="Y" cfsqltype="cf_sql_char" />
															...
															<tbody>
																...
																<cfoutput query="achdata">																		
																		...
																		<tr>																			
																			...
																			<td><cfif trim( feestatus ) is "paid"><span class="label label-success">PAID</span><cfelseif trim( feestatus ) is "pending"><span class="label label-info">PENDING</span><cfelseif trim( feestatus ) is "unpaid"><span class="label label-warning">UNPAID</span><cfelseif trim( feestatus ) is "nsf"><span class="label label-important">NSF</span></cfif></td>
																			<td><cfif trim( feestatus ) is "nsf"><span class="label label-inverse">N/A</span></cfif><cfif ( trim( feestatus ) is "paid" ) and ( feecollected eq 1 )><span class="label label-success">YES</span><cfelseif ( trim( feestatus ) is "pending" or trim( feestatus ) is "unpaid" ) and ( feecollected eq 0 )><span class="label label-inverse">NO</span></cfif></td>																										
																		</tr>
