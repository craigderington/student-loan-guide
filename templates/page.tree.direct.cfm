				...
				<cfif optiontree1.subcat1 is not true >
				...
				<cfelseif optiontree1.subcat1cancel911 is true >
					<cfset tabcancel = true />
				<cfelseif optiontree1.subcat1canceldeath is true >
					<cfset tabcancel = true />
				...
				<cfif optiontree1.subcat1post is true >
					<cfset tabpost = true />
				</cfif>
							...
							<div class="span9">
								...
								<div class="widget stacked">
									...
									<div class="widget-header">		
										...
										<h3>#treename# Option Tree Points for #leaddetail.leadfirst# #leaddetail.leadlast# </h3>						
									</div> <!-- //.widget-header -->
									</cfoutput>
												...
												<div class="tab-content">													
														...
														<div class="tab-pane <cfif tabcancel is true >active</cfif>" id="tabcancel">									
															...
															<cfif optiontree1.subcat1cancelunpaid is true>
																...
																<cfinvoke component="apis.com.clients.clarifyingpoints" method="getunpaidlist" returnvariable="unpaidlist">
																	<cfinvokeargument name="treenum" value="1">
														...
														<div class="tab-pane <cfif tabdefault is true and tabforgive is false and tabcancel is false>active</cfif>" id="tabdefault">													
															...
															<cfif optiontree1.subcat1default is true >
																...
																<cfif trim( optiontree1.subcat1rehab ) is "yes" >
																...
																<cfif trim( optiontree1.subcat1consol ) is "yes" >
																...
																<cfif trim( optiontree1.subcat1wg ) is "yes" >
																...
																<cfif trim( optiontree1.subcat1to ) is "yes" >
														...
														<div class="tab-pane <cfif tabpost is true and tabrepay is false and tabdefault is false and tabforgive is false and tabcancel is false>active</cfif>" id="tabpost">														
															...
															<cfif optiontree1.subcat1post is true >
																...
																<cfif trim( optiontree1.subcat1postdefer ) is "yes" >
																...
																<cfif trim( optiontree1.subcat1postforbear ) is "yes" >
