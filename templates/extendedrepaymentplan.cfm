										...
										<div class="widget-content">						
											...
											<div class="span4">
												<cfoutput>	
													...
													<h5 style="margin-top:25px;">&nbsp;</h5>
													<p>#cloanterm#</p>
													<p>#dollarformat( mExtPay.mExtPayAmt )#</p>
													<p>#dollarformat( ( mExtPay.mExtPayAmt * mExtPay.mExtTerm ) - cloaninfo.totalloanamount )#</p>
													<p>#dollarformat( mExtPay.mExtPayAmt * mExtPay.mExtTerm )#</p>
												</cfoutput>
											</div>			
										</div><!-- / .widget-content -->										
									</div><!-- // .widget -->
