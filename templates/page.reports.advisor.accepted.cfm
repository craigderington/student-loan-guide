												...
												<cfoutput query="advisoracceptedreport">								
													...
													<cfinvoke component="apis.udfs.cleanphonenumber" method="formatphonenumber" returnvariable="phonenumber">
														...
														<tr>
															...
															<td>#intakeadvisorname#   <cfif intakeadvisorname is not "" and leadassignacceptdate is ""><a style="margin-left:3px;" title="Transfer Advisor" href="javascript:;" onclick="window.open('templates/page.transfer.advisor.cfm?leadid=#leaduuid#&role=intake','','scrollbars=yes,width=840,height=540');"><i class="btn-icon-only icon-refresh"></i></a></cfif></td>
