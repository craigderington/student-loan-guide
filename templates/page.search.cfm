			...
			<cfinvoke component="apis.com.leads.leadgateway" method="getleadsearch" returnvariable="leadsearch">
						...
						<div class="span12">
							...
							<div class="widget stacked">
								...
								<div class="widget-content">						
									...
									<cfif leadsearch.recordcount gt 0>
										...
										<cfoutput><h5 style="color:##f90;">The search query found #leadsearch.recordcount# records matching your input.  Please select the lead record below...</h5></cfoutput>
										...
										<table id="myTable" class="table table-bordered table-striped table-highlight tablesorter">
											...
											<tbody>
												<cfoutput query="leadsearch" startrow="#url.startrow#" maxrows="#url.rowsperpage#">
												<tr>
													<td class="actions">													
											...
											<p style="float:left;">
												...
												<cfset totalRecords = leadsearch.recordcount >
												...
												<cfset endRow = (startRow + rowsPerPage) - 1 >													
													...
													<div style="float:right;">
														<a href="index.cfm?event=page.leads" class="btn btn-primary"><i class="icon-search"></i> Search Again</a>  <a href="index.cfm?event=page.index" class="btn btn-secondary"><i class="icon-dashboard"></i> Go to Dashboard</a>
													</div>
											</p>
									...
									<cfelse>
											...
											<p style="margin-top:20px;">
												<a href="index.cfm?event=page.leads" class="btn btn-tertiary" style="margin-right:7px;"><i class="icon-search"></i> Search Again</a>  <a href="index.cfm?event=page.index" class="btn btn-tertiary"><i class="icon-dashboard"></i> Go to Dashboard</a>
											</p>
									</cfif>
									<div class="clear"></div>
								</div> <!-- //.widget-content -->	
