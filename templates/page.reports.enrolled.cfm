			...
			<cfinvoke component="apis.com.reports.reportgateway" method="getenrolledreport" returnvariable="enrolledreport">
				<cfinvokeargument name="companyid" value="#session.companyid#">
			...
			<div class="main">
				...
				<div class="container">				
						...
						<div class="span12">
							...
							<div class="widget stacked">
								...
								<div class="widget-header">
									...
									<h3>Clients Enrolled Report for #session.companyname#</h3>
								</div> <!-- /widget-header -->
								</cfoutput>
								
								<div class="widget-content">						
									
									<cfif enrolledreport.recordcount gt 0>
									...
									<cfoutput>
										<h5><i class="icon-th-large"></i> This report found #enrolledreport.recordcount# client record<cfif enrolledreport.recordcount gt 1>s</cfif>     <span class="pull-right"><a href="#application.root#?event=page.reports" style="margin-bottom:5px;" class="btn btn-small btn-tertiary"><i class="icon-circle-arrow-left"></i> Reports Home</a><a href="#application.root#?event=page.reports.enrollment" style="margin-left:5px;margin-bottom:5px;" class="btn btn-small btn-default"><i class="icon-list-alt"></i> Outstanding Enrollment Report</a></span></h5>
									</cfoutput>
					...
					<cfif enrolledreport.recordcount lt 15>
