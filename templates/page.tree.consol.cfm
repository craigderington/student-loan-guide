									...
									<div class="widget-header">		
										...
										<div class="widget-content">							
											...
											<div class="alert alert-error">
												...
												<strong><i class="icon-question-sign"></i> IMPORTANT!</strong>  Please do not select a solution until you have reviewed all eligible loan options.
											</div>
												...
												<div class="tab-content">													
															...
															<cfif optiontree4.subcat4cancelatb is true>
																...
																<table class="table table-bordered table-striped table-highlight">
																	<thead>
																		<cfoutput>
																		<tr>
																			<th>Ability to Benefit <span style="float:right;"><a href="#application.root#?event=page.tree" class="btn btn-mini btn-tertiary">Return to Option Tree</a>&nbsp;&nbsp;<a href="#application.root#?event=page.worksheet.solution&tree=#tree#&option=cancel&solution=atb" class="btn btn-mini btn-primary">Choose This Solution</a></span></th>
																		</tr>
																		</cfoutput>
																	</thead>
																	<tbody>
															...
															<cfif optiontree4.subcat4cancelunpaid is true>
																...
																<table class="table table-bordered table-striped table-highlight">
																	<thead>
																		<cfoutput>
																		<tr>
																			<th>Unpaid Refund <span style="float:right;"><a href="#application.root#?event=page.tree" class="btn btn-mini btn-tertiary">Return to Option Tree</a>&nbsp;&nbsp;<a href="#application.root#?event=page.worksheet.solution&tree=#tree#&option=cancel&solution=refund" class="btn btn-mini btn-primary">Choose This Solution</a></span></th>
																		</tr>
																		</cfoutput>
																	</thead>
																	<tbody>
															...
															<cfif optiontree4.subcat4cancelcert is true>
																...
																<table class="table table-bordered table-striped table-highlight">
																	<thead>
																		<cfoutput>
																		<tr>
																			<th>False Certification <span style="float:right;"><a href="#application.root#?event=page.tree" class="btn btn-mini btn-tertiary">Return to Option Tree</a>&nbsp;&nbsp;<a href="#application.root#?event=page.worksheet.solution&tree=#tree#&option=cancel&solution=cert" class="btn btn-mini btn-primary">Choose This Solution</a></span></th>
																		</tr>
																		</cfoutput>
																	</thead>
																	<tbody>
														...
														<div class="tab-pane <cfif tabdefault is true and tabforgive is false and tabcancel is false >active</cfif>" id="tabdefault">													
															...
															<cfif optiontree4.subcat4default is true >
																...
																<cfif trim( optiontree4.subcat4consol ) is "yes" >
																	<cfif optiontree4.subcat4repay is true >	
																...
																<cfif trim( optiontree4.subcat4wg ) is "yes" >
																...
																<cfif trim( optiontree4.subcat4to ) is "yes" >
														...
														<div class="tab-pane <cfif tabpost is true and tabrepay is false and tabdefault is false and tabforgive is false and tabcancel is false >active</cfif>" id="tabpost">														
															...
															<cfif optiontree4.subcat4post is true >
																...
																<cfif trim( optiontree4.subcat4postforbear ) is "yes" >
